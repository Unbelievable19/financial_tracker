...
class Category extends DataClass implements Insertable<Category> {
  ...
  Category copyWith({int? id, String? title, String? color}) => Category(
    id: id ?? this.id,
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode => Object.hash(id, title, isIncome, value, date, category);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => CategoriesCompanion(id: id, title: title, color: color),
